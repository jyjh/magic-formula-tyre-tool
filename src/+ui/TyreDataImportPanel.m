    ...
    methods (Access = protected)
        ...
        function setupParserPanel(obj)
            p = uipanel(obj.Grid, ...
                ...
                'BorderType', 'none');
            g = uigridlayout(p, ...
                'RowHeight', {settings.LayoutSettings.DefaultButtonHeight, 'fit'}, ...
                'RowSpacing', settings.LayoutSettings.DefaultRowSpacing, ...
                'ColumnWidth', {'1x'}, ...
            ...
            w = settings.LayoutSettings.DefaultButtonWidthOnlyText;
            g = uigridlayout(g, ...
        ...
        function setupFilesPanel(obj)
            p = uipanel(obj.Grid, ...
                ...
                'BorderType', 'none');
            g = uigridlayout(p, ...
                'RowHeight', {200, settings.LayoutSettings.DefaultButtonHeight, ...
                    'fit',settings.LayoutSettings.DefaultButtonHeight,'fit'}, ...
                'ColumnWidth', {'1x'}, ...
                'Padding', settings.LayoutSettings.DefaultPadding);
            filesGrid = g;
            ...
            summaryHintGrid = uigridlayout(filesGrid, ...
                'ColumnWidth',{'1x',settings.LayoutSettings.DefaultButtonWidthOnlyIcon}, ...
                'RowHeight',{settings.LayoutSettings.DefaultButtonHeight}, ...
                'Padding',zeros(1,4), ...
                'ColumnSpacing',0);
